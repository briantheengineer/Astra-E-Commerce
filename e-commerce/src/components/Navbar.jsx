                ...
                <Link to="/landing" />
                    <div className="relative">
                        ...
                        <div className={`dropdown-menu ${isDropped ? '' : 'hidden'} border p-2 space-y-2 IntegralRegular z-50 absolute min-w-24 text-center myCategories`}>
                            ...
                            <p><Link to="/clothing/tops">Tops</Link></p><hr className="h-0" />
                            <p><Link to="/clothing/bikinis">Bikinis</Link></p><hr className="h-0" />
                            <p><Link to="/clothing/pants">Pants</Link></p>
                        </div>
                    </div>
                    ...
                    <h2 className="px-4 link IntegralRegular">Brands</h2>
                        ...
                        <svg onClick={toggleCart} className="w-7 h-7 m-2 link border"  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.29977 5H21L19 12H7.37671M20 16H8L6 3H3M9 20C9 20.5523 8.55228 21 8 21C7.44772 21 7 20.5523 7 20C7 19.4477 7.44772 19 8 19C8.55228 19 9 19.4477 9 20ZM20 20C20 20.5523 19.5523 21 19 21C18.4477 21 18 20.5523 18 20C18 19.4477 18.4477 19 19 19C19.5523 19 20 19.4477 20 20Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>    
                        <svg className="w-7 h-7 m-2 link border" xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="512" height="512"><path d="M16.043,14H7.957A4.963,4.963,0,0,0,3,18.957V24H21V18.957A4.963,4.963,0,0,0,16.043,14Z"/><circle cx="12" cy="6" r="6"/></svg>
                </nav>
            </div>
        </div>
    )
